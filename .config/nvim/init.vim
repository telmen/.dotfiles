...
" Plugin Options  {{{1
let g:coc_global_extensions="coc-css,coc-emmet,coc-eslint,coc-html,coc-json,coc-prettier,coc-snippets,coc-tailwindcss,coc-tslint,coc-tsserver,coc-yaml"
...
let g:ale_linters = {'javascript': ['eslint'], 'json': ['jsonlint']}
let g:ale_fixers = {
