...
sudo scutil --set ComputerName "telmen"
sudo scutil --set HostName "telmen"
sudo scutil --set LocalHostName "telmen"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "telmen"
...
tmpdir="${TMPDIR:-/tmp}"
[ ! -d $tmpdir ] && {
  echo -e "No ${tmpdir} directory. Aborting." >&2
  exit 1
}

# Alfred 3

if [ -f /Applications/Alfred.app ]; then
